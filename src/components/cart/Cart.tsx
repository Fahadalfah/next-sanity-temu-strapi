...
const Cart=()=> {
  ...
  return (
    ...
    <div
                className={`
                    fixed right-0 top-0 h-full w-full sm:w-[300px] bg-white shadow-2xl
                                      ...
                                      <div key={item.id} className='flex items-center gap-4 p-4 hover:bg-gray-50'>
                                        ...
                                        <div className='flex-1 min-w-0'>
                                            ...
                                            <div className='flex items-center gap-2'>
                                                ...
                                                className='bg-red-500 text-white px-2 py-1 rounded-full font-medium hover:bg-red-600 transition-colors'
